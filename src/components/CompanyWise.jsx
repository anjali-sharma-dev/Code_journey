...
const CompanyWise = ({item}) => {
  ...
  <button className="mt-4 w-full bg-[#00b8a3] text-white py-2 px-4 rounded-lg hover:bg-[#00a693] transition-colors" onClick={()=>{navigate(`/problems/company/${item.name}`);scrollTo(0,0)}}>
    Learn
  </button>
</div>
