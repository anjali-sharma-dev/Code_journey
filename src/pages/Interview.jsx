      ...
      <div className="bg-gradient-to-r from-white to-[#e6fff9] border-b border-[#e6fff9]">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-[#00b8a3]">Interview</h1>
              <p className="text-gray-600 mt-1">Tips, experiences, and preparation strategies</p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="bg-[#f9f9f9] border border-gray-200 rounded-lg p-6">
              ...
              <div className="mb-6">
                <h4 className="text-sm font-medium text-gray-600 mb-3">Role</h4>
                <div className="space-y-2">
                  <button className="w-full text-left px-3 py-2 rounded-md text-sm text-gray-600 hover:text-[#00b8a3] hover:bg-[#e6fff9] transition">Frontend</button>
                  <button className="w-full text-left px-3 py-2 rounded-md text-sm text-gray-600 hover:text-[#00b8a3] hover:bg-[#e6fff9] transition">Backend</button>
                  <button className="w-full text-left px-3 py-2 rounded-md text-sm text-gray-600 hover:text-[#00b8a3] hover:bg-[#e6fff9] transition">Full Stack</button>
                </div>
              </div>
            ...
            <div className="bg-[#f9f9f9] border border-gray-200 rounded-lg mb-4">
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-semibold text-gray-800">Interview Stories (3)</h2>
                ...
                {[1, 2, 3].map((id) => (
                  <div key={id} className="px-6 py-6 hover:bg-[#e6fff9] transition">
                    <div className="flex items-start space-x-4">
                      <div className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-sm font-bold text-gray-600">I</div>
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mb-3 line-clamp-2">
                          I was asked system design and DSA questions. Here's how I approached each round...
                        </p>
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          <div className="flex items-center space-x-1"><MessageSquare className="w-4 h-4" /><span>12</span></div>
                          <div className="flex items-center space-x-1"><Eye className="w-4 h-4" /><span>340</span></div>
                        </div>
                      </div>
                    </div>
                  </div>
